...
function Footer() {
  return (
    <>
      <div className="bg-gray-200 pt-4 bg-footerbg bg-cover bg-no-repeat h-full pb-60">
        ...
        <div className="flex flex-col items-center text-center font-serif pt-10 md:pt-36 flex-wrap mx-4">
